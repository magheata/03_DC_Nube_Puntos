...
public class Graph {
     ...
     */
    public GaussianFunctionPlotter function;
     ...
     */
    public Graph(PlotSettings p, double average, double stdDeviation) {

        this.function = new GaussianFunctionPlotter(average, stdDeviation);
        this.plotSettings = p;
    }
    ...
    public void draw(Graphics g, int width, int height) {
        ...
        */
        ...
        int xEqualsZero = (int) (getPlotX(0) + (plotSettings.getMinX() + plotSettings.getMaxX()) / 2);
